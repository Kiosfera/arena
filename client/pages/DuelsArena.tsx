...
const activeDuels: Duel[] = [
  {
    ...
    participants: [
      { id: "jose", name: "José", avatar: "👨‍🦱", votes: 1247, percentage: 58, totalBets: 5420 },
      { id: "alex", name: "Alex", avatar: "👨‍🦰", votes: 897, percentage: 42, totalBets: 3890 }
    ],
    timeRemaining: 180,
    totalPot: 9310,
    isActive: true,
  ...
  },
  {
    ...
    participants: [
      { id: "maria", name: "Maria", avatar: "👩‍🦳", votes: 892, percentage: 52, totalBets: 4230 },
      { id: "ana", name: "Ana", avatar: "👩‍🦱", votes: 823, percentage: 48, totalBets: 3870 }
    ],
    timeRemaining: 420,
    totalPot: 8100,
    isActive: true,
  ...
  },
  {
    ...
    participants: [
      { id: "pedro", name: "Pedro", avatar: "👨‍🦲", votes: 0, percentage: 50, totalBets: 0 },
      { id: "carlos", name: "Carlos", avatar: "👨‍🎤", votes: 0, percentage: 50, totalBets: 0 }
    ],
    timeRemaining: 900,
    totalPot: 0,
    isActive: false,
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center space-x-12 text-lg">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-bold text-red-400">{duels.filter(d => d.isActive).length}</span>
              <span className="text-gray-400">duelos ativos</span>
            </div>
            
            <div className="flex items-center space-x-3">
              <Eye className="h-6 w-6 text-blue-400" />
              <span className="font-bold text-blue-400">{formatNumber(totalActiveViewers)}</span>
              <span className="text-gray-400">assistindo</span>
            </div>
            
            <div className="flex items-center space-x-3">
              <DollarSign className="h-6 w-6 text-green-400" />
              <span className="font-bold text-green-400">R$ {formatNumber(totalActivePot)}</span>
          ...
          <div className="p-6">
            {selectedTab === "active" && (
              <div className="space-y-8">
                {duels.map((duel) => (
                  <div key={duel.id} className="bg-slate-700/30 border border-slate-600 rounded-2xl overflow-hidden">
                    {/* Duel Header */}
                    <div className="p-6 border-b border-slate-600">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <h3 className="text-2xl font-bold mb-2">{duel.title}</h3>
                        ...
                        <div className="text-right space-y-2">
                          ...
                          <div className="flex items-center space-x-4 text-sm">
                            <div className="flex items-center space-x-1">
                              ...
                              <span className="font-mono">{formatTime(duel.timeRemaining)}</span>
                            </div>
                      ...
                      {duel.participants.map((participant, index) => (
                        ...
                        >
                          ...
                          <div className="text-center mb-6">
                            ...
                            <h4 className="text-2xl font-bold mb-2">{participant.name}</h4>
                          ...
                          <div className="mb-6">
                            <div className="flex justify-between text-lg mb-3">
                              <span>Apoio</span>
                              <span className="font-bold">{participant.percentage}%</span>
                            </div>
            ...
            {selectedTab === "completed" && (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {completedDuels.map((duel) => (
                  <div key={duel.id} className="bg-slate-700/30 border border-slate-600 rounded-xl p-6">
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="space-y-3 mb-6">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-yellow-400 font-medium">Vencedor:</span>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span>{formatNumber(duel.participants)} participantes</span>
                      </div>
                    </div>
                    
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400 text-sm">{duel.category}</span>
        ...
        <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-2xl p-8 text-center backdrop-blur-sm">
          ...
          <p className="text-gray-300 text-lg mb-6">
            Battle Royale Final - Eliminatória definitiva com prêmio de R$ 50.000
          </p>
